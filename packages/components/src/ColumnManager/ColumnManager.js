...
import { Button, DataList, Modal, Text, TextContent, TextVariants } from '@patternfly/react-core';
import ColumnManagerListItem from './ColumnManagerListItem';

const ColumnManager = ({ isOpen, columns, onSave: onSaveArgument, onClose: onCloseProp, selectedColumns: selectedColumnsProp = [] }) => {
