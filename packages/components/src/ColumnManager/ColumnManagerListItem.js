...
const ColumnManagerListItem = ({ column, onChange, isSelected, isDisabled, id }) => (
  <DataListItem>
    <DataListItemRow>
      <DataListControl>
        <DataListCheck checked={isSelected} onChange={onChange} otherControls isDisabled={isDisabled} id={`${id}-id`} name={`${id}-id`} />
      </DataListControl>
      <DataListItemCells
        dataListCells={[
